...
<p align="center"><em>Генерирует скучную повторяющуюся часть каждого SDK.</em></p>
...
Из спецификации создаёт классы моделей, перечисления, коды ошибок, дескрипторы сервисов и таблицы для документации. Сознательно не генерирует HTTP-слой, роутер, middleware, FSM и всё, что связано с конкурентностью, - это пишется руками на каждом языке.
