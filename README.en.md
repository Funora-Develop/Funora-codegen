<p align="center">
  <img src="https://raw.githubusercontent.com/Funora-Develop/.github/main/assets/funora-codegen.svg" width="76" height="76" alt="">
</p>

<h1 align="center">Funora Codegen</h1>

<p align="center"><em>Generates the boring, repetitive part of every SDK.</em></p>
...
Produces model classes, enums, error codes, service descriptors and documentation tables from the spec. It deliberately does not generate the HTTP layer, the router, middleware, the FSM or anything concurrency-related - those are written by hand in each language.
